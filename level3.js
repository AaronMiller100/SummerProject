class level3 extends Phaser.Scene{
    ...
    create(){
        ...
        this.add.image(705, 28, 'level3corner');
        ...
        gameState.finish.add(new Finish(this, getXOnTilemap(8), getYOnTilemap(3), 'finishBlue', 'blue'));
        gameState.finish.add(new Finish(this, getXOnTilemap(10), getYOnTilemap(7), 'finishBlue', 'blue'));
        gameState.finish.add(new Finish(this, getXOnTilemap(8), getYOnTilemap(7), 'finishRed', 'red'));
        gameState.finish.add(new Finish(this, getXOnTilemap(10), getYOnTilemap(3), 'finishRed', 'red'));
        ...
        gameState.resource.add(new Resource(this, getXOnTilemap(6), getYOnTilemap(3), 'packageRed', gameState.redResourceAmount, 'red'));
        gameState.resource.add(new Resource(this, getXOnTilemap(4), getYOnTilemap(7), 'packageRed', gameState.redResourceAmount, 'red'));
        ...
        gameState.blueResourceAmountText2 = this.add.text(getXOnTilemap(6)-12, getYOnTilemap(7)-18, gameState.blueResourceAmount, { fontSize: "40px"});
        gameState.redResourceAmountText1 = this.add.text(getXOnTilemap(6)-12, getYOnTilemap(3)-18, gameState.redResourceAmount, {fontSize: "40px"});
        gameState.redResourceAmountText2 = this.add.text(getXOnTilemap(4)-12, getYOnTilemap(7)-18, gameState.redResourceAmount, {fontSize: "40px"});
        ...
        gameState.trucks.add(new Truck(this, getXOnTilemap(2), getYOnTilemap(7), 'truckright', 1, 11));
        ...
        setBackButtonInteractive(backButton, 'level3', this);
    ...
    update(){
        ...
        gameState.redResourceAmountText1.setText(gameState.redResourceAmount);
        gameState.redResourceAmountText2.setText(gameState.redResourceAmount);
        if (gameState.signalAndWaitUnlocked == true){
        ...
        levelStartedLogic(this, 'level3', 'level4', 3);
    }
}