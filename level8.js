class level8 extends Phaser.Scene{
    ...
    create(){
        ...
        this.add.image(705, 28, 'level8corner');
        ...
        gameState.finish.add(new Finish(this, getXOnTilemap(9), getYOnTilemap(2), 'finishBlue', 'blue'));
        gameState.finish.add(new Finish(this, getXOnTilemap(10), getYOnTilemap(5), 'finishBlue', 'blue'));
        gameState.finish.add(new Finish(this, getXOnTilemap(11), getYOnTilemap(8), 'finishBlue', 'blue'));
        gameState.finish.add(new Finish(this, getXOnTilemap(10), getYOnTilemap(2), 'finishRed', 'red'));
        gameState.finish.add(new Finish(this, getXOnTilemap(11), getYOnTilemap(5), 'finishRed', 'red'));
        gameState.finish.add(new Finish(this, getXOnTilemap(9), getYOnTilemap(8), 'finishRed', 'red'));
        gameState.finish.add(new Finish(this, getXOnTilemap(11), getYOnTilemap(2), 'finishGreen', 'green'));
        gameState.finish.add(new Finish(this, getXOnTilemap(9), getYOnTilemap(5), 'finishGreen', 'green'));
        gameState.finish.add(new Finish(this, getXOnTilemap(10), getYOnTilemap(8), 'finishGreen', 'green'));        

        gameState.resource = this.physics.add.group();
        gameState.blueResourceAmount = 2;
        gameState.redResourceAmount = 2;
        gameState.greenResourceAmount = 2;
        gameState.resource.add(new Resource(this, getXOnTilemap(3), getYOnTilemap(2), 'packageBlue', gameState.blueResourceAmount, 'blue'));   
        gameState.resource.add(new Resource(this, getXOnTilemap(5), getYOnTilemap(5), 'packageBlue', gameState.blueResourceAmount, 'blue'));   
        gameState.resource.add(new Resource(this, getXOnTilemap(7), getYOnTilemap(8), 'packageBlue', gameState.blueResourceAmount, 'blue'));   
        gameState.resource.add(new Resource(this, getXOnTilemap(5), getYOnTilemap(2), 'packageRed', gameState.redResourceAmount, 'red'));   
        gameState.resource.add(new Resource(this, getXOnTilemap(7), getYOnTilemap(5), 'packageRed', gameState.redResourceAmount, 'red'));   
        gameState.resource.add(new Resource(this, getXOnTilemap(3), getYOnTilemap(8), 'packageRed', gameState.redResourceAmount, 'red'));   
        gameState.resource.add(new Resource(this, getXOnTilemap(7), getYOnTilemap(2), 'packageGreen', gameState.greenResourceAmount, 'green'));
        gameState.resource.add(new Resource(this, getXOnTilemap(3), getYOnTilemap(5), 'packageGreen', gameState.greenResourceAmount, 'green'));
        gameState.resource.add(new Resource(this, getXOnTilemap(5), getYOnTilemap(8), 'packageGreen', gameState.greenResourceAmount, 'green'));
        ...
        gameState.blueResourceAmountText2 = this.add.text(getXOnTilemap(5)-12, getYOnTilemap(5)-18, gameState.blueResourceAmount, { fontSize: "40px"});
        gameState.blueResourceAmountText3 = this.add.text(getXOnTilemap(7)-12, getYOnTilemap(8)-18, gameState.blueResourceAmount, { fontSize: "40px"});
        gameState.redResourceAmountText1 = this.add.text(getXOnTilemap(5)-12, getYOnTilemap(2)-18, gameState.redResourceAmount, { fontSize: "40px"});
        gameState.redResourceAmountText2 = this.add.text(getXOnTilemap(7)-12, getYOnTilemap(5)-18, gameState.redResourceAmount, { fontSize: "40px"});
        gameState.redResourceAmountText3 = this.add.text(getXOnTilemap(3)-12, getYOnTilemap(8)-18, gameState.redResourceAmount, { fontSize: "40px"});
        gameState.greenResourceAmountText1 = this.add.text(getXOnTilemap(7)-12, getYOnTilemap(2)-18, gameState.greenResourceAmount, { fontSize: "40px"});
        gameState.greenResourceAmountText2 = this.add.text(getXOnTilemap(3)-12, getYOnTilemap(5)-18, gameState.greenResourceAmount, { fontSize: "40px"});
        gameState.greenResourceAmountText3 = this.add.text(getXOnTilemap(5)-12, getYOnTilemap(8)-18, gameState.greenResourceAmount, { fontSize: "40px"});


        

        gameState.trucks = this.physics.add.group();
        gameState.trucks.add(new Truck(this, getXOnTilemap(1), getYOnTilemap(2), 'truckright', 1, 12));     
        gameState.trucks.add(new Truck(this, getXOnTilemap(1), getYOnTilemap(5), 'truckright', 1, 12)); 
        gameState.trucks.add(new Truck(this, getXOnTilemap(1), getYOnTilemap(8), 'truckright', 1, 12)); 
        ...
        setBackButtonInteractive(backButton, 'level8', this);
        ...
        this.physics.add.overlap(gameState.trucks, gameState.finish, function (truck, finish){truckFinishCollisionLogic(truck, finish, 9)}, null, this);
    ...
    update(){
        ...
        gameState.redResourceAmountText3.setText(gameState.redResourceAmount, { fontSize: "40px"});
        ...
        gameState.greenResourceAmountText3.setText(gameState.greenResourceAmount, { fontSize: "40px"});
        ...
        levelStartedLogic(this, 'level8', 'level9', 8);
    }
}